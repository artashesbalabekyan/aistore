...
- [AIStore](https://github.com/artashesbalabekyan/aistore) provides fast, scalable storage along with powerful features (including co-located ETL) to enhance AI workloads.
...
All code used below can be found here: [Inline WebDataset Transform Example](https://github.com/artashesbalabekyan/aistore/blob/master/docs/examples/aisio_webdataset/load_webdataset_example.py)
...
- [AIStore Cluster v3.17](https://github.com/artashesbalabekyan/aistore) -- Running in Kubernetes (see [here](https://github.com/artashesbalabekyan/aistore/blob/master/deploy/dev/k8s/README.md) for minikube deployment or [here](https://github.com/artashesbalabekyan/aistore/blob/master/docs/getting_started.md#kubernetes-deployments) for more advanced options)
...
The full code is available [here](https://github.com/artashesbalabekyan/aistore/blob/master/docs/examples/aisio_webdataset/load_webdataset_example.py) but the key points are shown below:
...
3. Full code example
    - [Inline WebDataset Transform Example](https://github.com/artashesbalabekyan/aistore/blob/master/docs/examples/aisio_webdataset/load_webdataset_example.py)
4. Dataset
