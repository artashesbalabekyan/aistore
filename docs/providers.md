...
> There are advanced-usage type options to skip Steps 1. and 2. above - see e.g. [`LisObjsMsg flags`](https://github.com/artashesbalabekyan/aistore/blob/master/api/apc/lsmsg.go#L15-L56)
