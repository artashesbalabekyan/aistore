...
def _assert_aistore() -> None:
    if not HAS_AIS:
        raise ModuleNotFoundError(
            ...
            "For more info visit: https://github.com/artashesbalabekyan/aistore/blob/master/python/aistore/"
        )
...
class AISFileLoaderIterDataPipe(IterDataPipe[Tuple[str, StreamWrapper]]):
    ...
    -   An `etl_name` can be provided to run an existing ETL on the AIS cluster.
        See https://github.com/artashesbalabekyan/aistore/blob/master/docs/etl.md for more info on AIStore ETL.
